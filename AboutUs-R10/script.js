$(function(){
	...
	function init(){
		...
		$('.section.intro .pc p,.section.intro h2,.section.intro h3').each(function(i){
		...
		$("#sp-menu .close").click(function () {
			...
			$('body > div:not(#sp-menu,.video_fade_wrap)').show();
			$('#sp-menu').fadeOut(1);
		});
	...
	function reloadHandler(){
		...
		$('.section.intro p,.section.intro h2,.section.intro h3').each(function(i,c){$(this).css('opacity',0)});
